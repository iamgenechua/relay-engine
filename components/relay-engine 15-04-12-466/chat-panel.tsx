...
import EventTimeline from "@/components/relay-engine 15-04-12-466/event-timeline";
import ClassificationCard from "@/components/relay-engine 15-04-12-466/classification-card";
...
export default function ChatPanel({
	...
	const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
		...
		console.log(
			"[relay] handleSubmit fired — value:",
			...
			{isOpen && (
				<motion.div
					...
					style={{
						...
						overflow: "hidden",
						boxShadow:
							"0 8px 40px rgba(26, 26, 24, 0.12), 0 2px 8px rgba(26, 26, 24, 0.06)",
					}}
				>
					...
					>
						...
						<EventTimeline
							...
							isVisible={timelineEvents.length > 0}
						/>
